...
// Fetch all columns from book_online
$stmt = $conn->prepare("SELECT * FROM book_online ORDER BY id DESC");
if (!$stmt) {
...
send_response(true, 'Online books fetched successfully', $books);
?>
